...
CallExpr = id:Identifier _ '(' _ head:(_   Expr / Identifier _) _ ? tail:(_ ',' _ (Expr / Identifier))* ')' {
...
Expr =  ArrayLiteral / CallExpr / ObjectLiteral / BinaryExpr / Literal

BinaryExpr = left:(Identifier / Literal / CallExpr) _ op:BIN_OPS _ right:(CallExpr / Identifier / Literal /  BinaryExpr) {
...
Identifier = head:[$_a-zA-Z] tail:[a-zA-Z0-9]*  other: (('[' (Identifier / BinaryExpr / [0-9])+ ']') / ('.' [a-zA-Z0-9]+))*{
